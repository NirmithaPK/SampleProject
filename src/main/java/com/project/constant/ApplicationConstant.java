...
public class ApplicationConstant {
	...
	public static final String GROUP_ID_STRING = "group-id-test";
	public static final String TOPIC_NAME = "sampleTopic";
	public static final String KAFKA_LISTENER_CONTAINER_FACTORY = "kafkaListenerContainerFactory";
	public static final String GROUP_ID_JSON = "group-id-testJson";
}
